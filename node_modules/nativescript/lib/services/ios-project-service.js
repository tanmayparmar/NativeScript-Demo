...
class IOSProjectService extends projectServiceBaseLib.PlatformProjectServiceBase {
    constructor($fs, $childProcess, $cocoapodsService, $errors, $logger, $iOSEmulatorServices, $injector, $projectDataService, $prompter, $config, $devicePlatformsConstants, $devicesService, $mobileHelper, $pluginVariablesService, $xcprojService, $iOSProvisionService, $sysInfo) {
    ...
    validateOptions(projectId, provision) {
        return __awaiter(this, void 0, void 0, function* () {
            if (provision === true) {
                yield this.$iOSProvisionService.list(projectId);
    ...
    createProject(frameworkDir, frameworkVersion, projectData, pathToTemplate) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    archive(projectData, buildConfig, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.$childProcess.spawnFromEvent("xcodebuild", args, "exit", { stdio: 'inherit' });
            return archivePath;
        });
    }
...
`;
    ...
    exportDevelopmentArchive(projectData, buildConfig, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.$childProcess.spawnFromEvent("xcodebuild", args, "exit", { stdio: buildConfig.buildOutputStdio || 'inherit', cwd: this.getPlatformData(projectData).projectRoot }, { emitOptions: { eventName: constants.BUILD_OUTPUT_EVENT_NAME }, throwError: true });
            return exportFile;
        });
    }
    ...
    buildProject(projectRoot, projectData, buildConfig) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (buildConfig.buildForDevice) {
                ...
                yield helpers_1.attachAwaitDetach(constants.BUILD_OUTPUT_EVENT_NAME, this.$childProcess, handler, this.buildForSimulator(projectRoot, basicArgs, projectData, buildConfig.buildOutputStdio));
            }
        });
    }
    validatePlugins(projectData) {
        return __awaiter(this, void 0, void 0, function* () {
            let installedPlugins = yield this.$injector.resolve("pluginsService").getAllInstalledPlugins(projectData);
            for (let pluginData of installedPlugins) {
                ...
                let cocoaPodVersion = yield this.$sysInfo.getCocoapodVersion();
    ...
    buildForDevice(projectRoot, args, buildConfig, projectData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!buildConfig.release && !buildConfig.architectures) {
                yield this.$devicesService.initialize({ platform: this.$devicePlatformsConstants.iOS.toLowerCase(), deviceId: buildConfig.device });
            ...
            yield this.$childProcess.spawnFromEvent("xcodebuild", args, "exit", { stdio: buildConfig.buildOutputStdio || "inherit", cwd: this.getPlatformData(projectData).projectRoot }, { emitOptions: { eventName: constants.BUILD_OUTPUT_EVENT_NAME }, throwError: true });
            yield this.createIpa(projectRoot, projectData, buildConfig);
        });
    }
    setupSigningFromProvision(projectRoot, projectData, provision) {
        return __awaiter(this, void 0, void 0, function* () {
            if (provision) {
                ...
                if (shouldUpdateXcode) {
                    ...
                    const mobileprovision = yield this.$iOSProvisionService.pick(provision, projectData.projectId);
    ...
    buildForSimulator(projectRoot, args, projectData, buildOutputStdio) {
        return __awaiter(this, void 0, void 0, function* () {
            args = args.concat([
                "-sdk", "iphonesimulator",
                "ARCHS=i386 x86_64",
            ...
            yield this.$childProcess.spawnFromEvent("xcodebuild", args, "exit", { stdio: buildOutputStdio || "inherit", cwd: this.getPlatformData(projectData).projectRoot }, { emitOptions: { eventName: constants.BUILD_OUTPUT_EVENT_NAME }, throwError: true });
        });
    }
    createIpa(projectRoot, projectData, buildConfig) {
        return __awaiter(this, void 0, void 0, function* () {
            let xarchivePath = yield this.archive(projectData, buildConfig);
            let exportFileIpa = yield this.exportDevelopmentArchive(projectData, buildConfig, {
    ...
    addFramework(frameworkPath, projectData) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.validateFramework(frameworkPath);
            ...
            let isDynamic = _.includes((yield this.$childProcess.spawnFromEvent("otool", ["-Vh", frameworkBinaryPath], "close")).stdout, " DYLIB ");
    ...
    addStaticLibrary(staticLibPath, projectData) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.validateStaticLibrary(staticLibPath);
...
<document type="com.apple.InterfaceBuilder3.CocoaTouch.XIB" version="3.0" toolsVersion="6751" systemVersion="14A389" targetRuntime="iOS.CocoaTouch" propertyAccessControl="none" useAutolayout="YES" launchScreen="YES" useTraitCollections="YES">
    ...
    prepareProject(projectData, platformSpecificData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (provision) {
                let projectRoot = path.join(projectData.platformsDir, "ios");
                yield this.setupSigningFromProvision(projectRoot, provision);
            }
            let project = this.createPbxProj(projectData);
    ...
    processConfigurationFilesFromAppResources(release, projectData) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.mergeInfoPlists(projectData);
            yield this.mergeProjectXcconfigFiles(release, projectData);
            for (let pluginData of yield this.getAllInstalledPlugins(projectData)) {
    ...
    getInfoPlistPath(projectData) {
        return path.join(projectData.projectDir, constants.APP_FOLDER_NAME, constants.APP_RESOURCES_FOLDER_NAME, this.getPlatformData(projectData).normalizedPlatformName, this.getPlatformData(projectData).configurationFileName);
    }
    ...
    mergeInfoPlists(projectData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let allPlugins = yield this.getAllInstalledPlugins(projectData);
    ...
    validateFramework(libraryPath) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let packageType = (yield this.$childProcess.spawnFromEvent("/usr/libexec/PlistBuddy", ["-c", "Print :CFBundlePackageType", infoPlistPath], "close")).stdout.trim();
            if (packageType !== "FMWK") {
    ...
    validateStaticLibrary(libraryPath) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let archsInTheFatFile = yield this.$childProcess.exec("lipo -i " + libraryPath);
    ...
    executePodInstall(projectData) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.$childProcess.exec("gem which cocoapods");
                yield this.$childProcess.exec("gem which xcodeproj");
            }
            catch (e) {
            ...
            let childProcess = yield this.$childProcess.spawnFromEvent(podTool, ["install"], "close", { cwd: this.getPlatformData(projectData).projectRoot, stdio: ['pipe', process.stdout, 'pipe'] });
    ...
    prepareCocoapods(pluginPlatformsFolderPath, projectData, opts) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.$fs.exists(pluginPodFilePath)) {
                let pluginPodFileContent = this.$fs.readText(pluginPodFilePath), pluginPodFilePreparedContent = this.buildPodfileContent(pluginPodFilePath, pluginPodFileContent), projectPodFileContent = this.$fs.exists(this.getProjectPodFilePath(projectData)) ? this.$fs.readText(this.getProjectPodFilePath(projectData)) : "";
                if (!~projectPodFileContent.indexOf(pluginPodFilePreparedContent)) {
                    let podFileHeader = this.$cocoapodsService.getPodfileHeader(projectData.projectName), podFileFooter = this.$cocoapodsService.getPodfileFooter();
    ...
    mergeProjectXcconfigFiles(release, projectData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let allPlugins = yield this.$injector.resolve("pluginsService").getAllInstalledPlugins(projectData);
            for (let plugin of allPlugins) {
                ...
                if (this.$fs.exists(pluginXcconfigFilePath)) {
                    yield this.mergeXcconfigFiles(pluginXcconfigFilePath, release ? this.getPluginsReleaseXcconfigFilePath(projectData) : this.getPluginsDebugXcconfigFilePath(projectData));
                }
            }
            ...
            if (this.$fs.exists(appResourcesXcconfigPath)) {
                yield this.mergeXcconfigFiles(appResourcesXcconfigPath, release ? this.getPluginsReleaseXcconfigFilePath(projectData) : this.getPluginsDebugXcconfigFilePath(projectData));
            }
    ...
    checkIfXcodeprojIsRequired() {
        return __awaiter(this, void 0, void 0, function* () {
            let xcprojInfo = yield this.$xcprojService.getXcprojInfo();
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!teamId) {
                ...
                if (teams.length === 1) {
                    ...
                    let choice = yield this.$prompter.promptForChoice('Found multiple development teams, select one:', choices);
                    ...
                    let choicePersist = yield this.$prompter.promptForChoice("Do you want to make teamId: " + teamId + " a persistent choice for your app?", choicesPersist);
